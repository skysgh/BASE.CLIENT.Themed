...
export declare class SliderLabelDirective extends SliderElementDirective {
    ...
    private _value;
    get value(): string;
    constructor(elemRef: ElementRef, renderer: Renderer2, changeDetectionRef: ChangeDetectorRef, allowUnsafeHtmlInSlider: boolean);
    setValue(value: string): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<SliderLabelDirective, [null, null, null, { optional: true; }]>;
