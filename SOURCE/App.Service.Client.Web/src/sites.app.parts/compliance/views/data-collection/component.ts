    ...
    <div class="policy-page">
      <div class="page-header d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <h4 class="d-inline-block mb-0"><i class="bx bx-data me-2 text-danger"></i>Data Collection Statement</h4>
        </div>
      </div>
      <div class="card"><div class="card-body"><p>Data collection statement placeholder.</p></div></div>
