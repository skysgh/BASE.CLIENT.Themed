    ...
    <div class="about-hub">
      ...
      <div *ngIf="!aboutService.loading()">
            ...
            <div class="card h-100">
              <div class="card-body text-center">
                ...
                <div class="small text-muted">
                  <span *ngIf="aboutService.theme()?.style">{{ aboutService.theme()?.style }}</span>
                  <span *ngIf="aboutService.theme()?.style && aboutService.theme()?.layout"> · </span>
                  <span *ngIf="aboutService.theme()?.layout">{{ aboutService.theme()?.layout }}</span>
                </div>
                <div class="mt-2">
                  <span class="badge" 
        ...
        <div class="d-flex gap-3 flex-wrap justify-content-center text-muted small mt-4">
          ...
          <a *ngIf="aboutService.theme()?.urls?.themeForest"
