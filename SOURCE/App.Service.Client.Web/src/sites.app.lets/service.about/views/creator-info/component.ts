...
@Component({
  ...
  template: `
    <div class="creator-page">
      ...
      <div *ngIf="aboutService.creator() as creator">
          ...
          <div class="card-body">
            <div class="d-flex align-items-center mb-4">
              <div class="creator-logo me-4">
                <img *ngIf="creator.logo" 
                     [src]="creator.logo" 
                     [alt]="creator.name"
                     class="img-fluid"
                     style="max-height: 80px;">
                <div *ngIf="!creator.logo" class="logo-placeholder">
            ...
            <p *ngIf="creator.description" class="mb-4">
              {{ creator.description }}
            </p>
