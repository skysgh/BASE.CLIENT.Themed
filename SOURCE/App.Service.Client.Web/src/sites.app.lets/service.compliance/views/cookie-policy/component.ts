      ...
      <div class="page-header d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <h4 class="d-inline-block mb-0">
            <i class="bx bx-cookie me-2 text-warning"></i>
            Cookie Policy
          </h4>
        </div>
      </div>
...
export class CookiePolicyComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.accountService.getConfigValue<string>('compliance.cookies.pdf')
      .subscribe(path => {
        this.pdfSrc = path || '/assets/data/compliance/cookie-policy.pdf';
      });
  }
}
