...
export function mapArchitecturePrincipleDtoToViewModel(dto: ArchitecturePrincipleDto): ArchitecturePrincipleViewModel {
  return {
    id: dto.id,
    typeId: dto.typeFk,
    title: dto.title,
...
export function mapArchitecturePrincipleDtosToViewModels(dtos: ArchitecturePrincipleDto[]): ArchitecturePrincipleViewModel[] {
  return dtos.map(dto => mapArchitecturePrincipleDtoToViewModel(dto));
}
