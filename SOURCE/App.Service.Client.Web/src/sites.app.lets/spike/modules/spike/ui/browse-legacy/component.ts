...
/**
 * LEGACY Browse Component
 * 
 * ⚠️ This is the LEGACY browse component, kept for reference.
 * The new browse uses Universal Search infrastructure.
 * 
 * @deprecated Use the new browse component with Universal Search
 */
@Component({
    selector: 'app-base-apps-spike-spikes-browse-legacy',
    templateUrl: './component.html',
    styleUrls: ['./component.scss'],
    standalone: false
})
export class BaseAppsSpikeSpikesBrowseLegacyComponent implements OnInit {
