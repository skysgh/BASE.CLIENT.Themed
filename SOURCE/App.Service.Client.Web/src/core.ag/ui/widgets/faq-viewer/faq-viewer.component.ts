...
export class FaqViewerComponent implements OnInit {
  // ✅ FIXED: Explicitly type the injected services
  categoryService: FaqCategoryService = inject(FaqCategoryService);
  itemService: FaqItemService = inject(FaqItemService);
   ...
   */
  getCategoryIconClass(category: FaqCategoryViewModel): string {
    return (category.iconClass || 'bx bx-help-circle') + ' fs-24 align-middle text-success me-1';
  }
