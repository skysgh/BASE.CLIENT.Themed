 ...
 * 
 * Near-direct copy from Velzon theme: pages/charts
 * Provides chart library reference pages for developers.
 * 
 * Source: Velzon (Minimal) - charts module
 */
...
// Chart.js - Import via NgChartsModule
...
export class ChartsReferenceModule {}
