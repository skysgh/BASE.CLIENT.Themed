/**
 * Charts Reference Routing
 * 
 * Near-direct copy from Velzon theme: pages/charts/charts-routing.module.ts
 */
import { NgModule } from '@angular/core';
import { RouterModule, Routes } from '@angular/router';

// Component pages - Apexcharts
...
// Component pages - Other chart libraries
...
const routes: Routes = [
  ...
  { path: "apex-polar", component: PolarComponent },
  { path: "range-area", component: RangeAreaComponent },
  { path: "funnel", component: FunnelComponent },
  { path: "slope", component: SlopeareaComponent },
...
export class ChartsReferenceRoutingModule { }
