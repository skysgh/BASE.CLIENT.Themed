/**
 * Forms Reference Routing
 * 
 * Near-direct copy from Velzon theme: pages/form/form-routing.module.ts
 */
...
const routes: Routes = [
  ...
  { path: "checkboxs-radios", component: CheckboxsRadiosComponent },
  { path: "pickers", component: PickersComponent },
  { path: "masks", component: MasksComponent },
  { path: "advanced", component: AdvancedComponent },
  { path: "range-sliders", component: RangeSlidersComponent },
...
export class FormsReferenceRoutingModule {}
