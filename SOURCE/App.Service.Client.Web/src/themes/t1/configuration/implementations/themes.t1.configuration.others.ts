...
/** Implementation of
 *  the TThemesT1ConfigurationOthers type
 * providing quick access to other configuration objects.
 */
export const themesT1ConfigurationOthers: TThemesT1ConfigurationOthers = {
